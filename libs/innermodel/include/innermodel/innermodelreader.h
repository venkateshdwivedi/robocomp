...
private:
	static bool include(const QString &file, InnerModel *model, InnerModel::TransformPtr node);
	static void recursive(QDomNode parentDomNode, InnerModel *model, InnerModel::NodePtr imNode);
