...
private:
	static bool include(const QString &file, InnerModel *model, InnerModelNode::NodePtr node);
	static void recursive(QDomNode parentDomNode, InnerModel *model, InnerModelNode::NodePtr imNode);
